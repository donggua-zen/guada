import { ILINK_CDN_ROOT_DEFAULT, ILINK_QR_BOT_CLASS_DEFAULT } from "../internal/config";
import { delay } from "../internal/async-tools";
import { GatewayFault } from "../internal/errors";
import { nextScopedOpId } from "../internal/random-tags";
import type { IlinkJsonTransport } from "../transport/ilink-json-transport";
import type { CredentialBlob, LoginOutcome, LoginTicket, WaitForLoginOptions } from "../protocol/chat-event";
