...
export const PLATFORM_METADATA: Record<string, PlatformMetadata> = {
  ...
  'wechat-personal': {
    ...
    displayName: '微信个人号',
    icon: 'wechat',
    description: '接入微信个人号机器人（基于 iLink Bot HTTP API，扫码登录）',
    fields: [
      {
        key: 'baseUrl',
        label: 'iLink API 地址',
        ...
        description: 'iLink Bot HTTP API 网关地址，私有部署可修改',
      },
      {
        key: 'cdnBaseUrl',
        label: 'CDN 地址',
        type: 'text',
        required: false,
        defaultValue: 'https://novac2c.cdn.weixin.qq.com/c2c',
        placeholder: 'https://novac2c.cdn.weixin.qq.com/c2c',
        description: '媒体文件 CDN 地址，默认使用微信官方 CDN',
      },
      {
        key: 'qrLoginTimeoutMs',
        label: '扫码登录超时',
        type: 'number',
        required: false,
        defaultValue: 480000,
        placeholder: '480000',
        description: '二维码扫码登录超时时间（毫秒，默认 8 分钟）',
      },
      {
        key: 'pollingTimeoutMs',
        label: '轮询超时',
        type: 'number',
        required: false,
        defaultValue: 35000,
      ...
      {
        key: 'pollingRetryDelayMs',
        label: '轮询重试间隔',
        type: 'number',
        required: false,
        defaultValue: 3000,
        placeholder: '3000',
        description: '轮询失败后的重试间隔（毫秒）',
      },
    ],
  },
  discord: {
