...
export class KnowledgeBaseService {
    ...
    async update(kbId: string, userId: string, data: any) {
        ...
        try {
            ...
            if (data.embedding_model_id !== undefined) updateData.embeddingModelId = data.embedding_model_id;
            if (data.chunk_max_size !== undefined) updateData.chunkMaxSize = data.chunk_max_size;
            if (data.chunk_overlap_size !== undefined) updateData.chunkOverlapSize = data.chunk_overlap_size;
            if (data.chunk_min_size !== undefined) updateData.chunkMinSize = data.chunk_min_size;
