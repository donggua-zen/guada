...
export class MessagesController {
    ...
    async getMessages(@Param('sessionId') sessionId: string, @CurrentUser() user: any) {
    ...
    async deleteMessage(@Param('messageId') messageId: string, @CurrentUser() user: any) {
    ...
    async updateMessageActiveContent(
        ...
        return this.messageService.setMessageCurrentContent(body.message_id, contentId);
    }
