...
export interface MessageRecord {
  ...
  metadata?: Partial<Record<"referencedKbs" | "thinkingDurationMs" | "modelName" | "usage" | "finishReason" | "error" | "approvalContext" | "resumeContext" | "signature" | "redactedData" | "runMode" | "systemReminder", any>> | undefined;
  // usage?: any;
  // finishReason?: string;
  // error?: string;
