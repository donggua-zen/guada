<template>
  ...
  <Teleport to="body">
    <Transition name="dropdown-fade">
      <div v-if="visible" ref="menuRef" class="fixed z-50 bg-(--color-surface) rounded-(--size-dialog-rounded-radius) shadow-lg border border-(--color-surface-border) py-1 min-w-30" :style="menuStyle" @click.stop>
