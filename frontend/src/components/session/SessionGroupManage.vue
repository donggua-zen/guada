                        ...
                        <div
                            ...
                            <template v-else>
                                ...
                                <div class="flex items-center gap-1">
                                    <div
                                        class="action-btn p-1 rounded cursor-pointer hover:bg-gray-100 dark:hover:bg-[#2a2c30]"
                                    ...
                                    <div
                                        class="action-btn p-1 rounded cursor-pointer hover:bg-red-50 dark:hover:bg-red-900/20"
