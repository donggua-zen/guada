<template>
  <div v-if="isElectron" class="custom-titlebar" :class="{ 'drag-region': true }">
    ...
    <div class="titlebar-right no-drag">
      <!-- Debug 按钮 -->
      <button class="titlebar-button debug-button" @click="toggleDevTools" title="开发者工具">
